...
const ScanStatsContext = createContext<ScanStatsContextType | undefined>(
  undefined,
);
...
export const ScanStatsProvider: React.FC<ScanStatsProviderProps> = ({
  children,
}) => {
...
export const useScanStatsContext = (): ScanStatsContextType => {
  ...
  if (context === undefined) {
    throw new Error(
      "useScanStatsContext must be used within a ScanStatsProvider",
    );
  }
  return context;
};
