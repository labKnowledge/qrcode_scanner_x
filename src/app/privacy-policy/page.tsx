...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for ScanPro QR code processing service. Learn how we collect, use, and protect your information.",
};
      ...
      <Paper elevation={0} sx={{ p: { xs: 3, md: 6 }, borderRadius: 2 }}>
        ...
        <Box sx={{ mb: 6 }}>
          ...
          <Typography variant="body1" paragraph>
            At ScanPro, we take your privacy seriously. This Privacy Policy
            explains how we collect, use, disclose, and safeguard your
            information when you use our QR code processing service.
          </Typography>
        </Box>
